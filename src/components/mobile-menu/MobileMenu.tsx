...
const MobileMenu = () => {
  return (
    <div className="bg-background text-on-background font-body-md antialiased min-h-screen">
      ...
      <nav className="bg-[#e5e1d8] rounded-r-lg h-full w-4/5 fixed inset-0 z-50 flex flex-col p-8 gap-6 shadow-2xl shadow-stone-900/10">
        ...
        <ul className="flex-1 flex flex-col gap-2 mt-4 font-serif Newsreader text-2xl leading-relaxed">
          ...
          <li className="flex items-center gap-4 py-3 group cursor-pointer text-stone-700 pl-4 hover:text-[#c2652a] hover:translate-x-2 transition-transform duration-300">
            <span
              className="material-symbols-outlined text-[28px] text-[#c2652a]"
              data-icon="shield"
            >
              shield
            </span>
