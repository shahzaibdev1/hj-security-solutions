...
const NotFound = () => {
  return (
    <main className="min-h-screen flex items-center justify-center pt-20">
      {/* <!-- 404 Canvas Area --> */}
      <div className="relative w-full max-w-[1280px] mx-auto px-8 grid grid-cols-1 gap-xl items-center max-w-2xl text-center">
        {/* Visual Element */}
        {/* Content Element */}
        <div className="order-1 lg:order-2 flex flex-col space-y-md items-center">
          ...
          <div className="mt-xl pt-lg border-t border-surface-container-highest w-full flex flex-col items-center">
            ...
            <nav className="grid grid-cols-1 sm:grid-cols-2 gap-base max-w-2xl text-center justify-items-center sm:justify-items-start">
              <Link
